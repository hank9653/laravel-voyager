...
class BreadService extends BaseVoyagerAuthController {
    ...
    public function show($request, $id, $slug)
    {
    ...
    public function upload(Request $request, $id, $slug)
    {
        //$slug = $this->getSlug($request);
    ...
    public function destroy(Request $request, $id, $slug)
    {
        //$slug = $this->getSlug($request);
